...
export const Main: MapDef = {
    ...
    lootTable: {
        ...
        tier_guns_rare_demo: [
            ...
            { name: "saiga", count: 1, weight: 0.525 },
            { name: "usas", count: 1, weight: 0.075 }, 
        ],
        tier_guns_rare_healer: [
            { name: "svd", count: 1, weight: 0.35 }, 
            { name: "l86", count: 1, weight: 0.35 }, 
            { name: "garand", count: 1, weight: 0.3 }, 
        ],
        tier_guns_rare_assault: [
            { name: "scar", count: 1, weight: 0.3 },
            { name: "grozas", count: 1, weight: 0.3 }, 
            { name: "m4a1", count: 1, weight: 0.3 },
            { name: "an94", count: 1, weight: 0.1 ), 
        ], 
        tier_guns_rare_tank: [
            { name: "qbb97", count: 1, weight: 0.85 }, 
            { name: "pkp", count: 1, weight: 0.1 },
            { name: "m249", count: 1, weight: 0.05 }, 
        ],
        ...
        tier_scavenger_adv: [
            ...
            { name: "outfitGhillie", count: 1, weight: 0.2 },
            { name: "painkiller", count: 1, weight: 1 },

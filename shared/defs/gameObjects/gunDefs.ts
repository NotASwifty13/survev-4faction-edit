...
export const GunDefs: Record<string, GunDef> = {
    ...
    asval: {
        ...
        shotSpread: 3.44,
        bulletCount: 1,
        bulletType: "bullet_asval",
        bulletTypeBonus: "bullet_asval_bonus",
        headshotMult: 1.2,
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "img/loot/loot-weapon-asval.svg",
            tint: 65280,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
        ...
        worldImg: {
            sprite: "img/guns/gun-asval-01.svg",
            scale: { x: 0.6, y: 0.6 },
            tint: 0xffffff,
            leftHandOffset: { x: 9, y: 0 },
            recoil: 1,
        ...
        sound: {
            shoot: "asval_01",
            reload: "asval_reload_01",
            pickup: "asval_switch_01",
            empty: "empty_fire_01",
            deploy: "asval_switch_01",
        },
    },
    famas: {
        name: "FAMAS",
    ...
    aa12: {
        ...
        bulletCount: 4,
        jitter: 0.2,
        bulletType: "bullet_shrap",
        headshotMult: 1.5,
        speed: { equip: 0, attack: 2 },
        lootImg: {
            sprite: "img/loot/loot-weapon-aa12.svg",
            tint: 65280,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
        ...
        worldImg: {
            sprite: "img/guns/gun-aa12-01.svg",
            scale: { x: 0.7, y: 0.5 },
            tint: 0xFFFFFF,
            leftHandOffset: { x: 4.8, y: 0 },
            recoil: 1.33,
